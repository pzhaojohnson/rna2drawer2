...
function Header() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }} >
      <p style={{ margin: '0px 72px', fontSize: '24px' }} >
...
export function CreateNewDrawing(props: Props): React.ReactElement {
  ...
  return (
    <FloatingDrawingsContainer
      contained={
        <div style={{ margin: '0px 20px', width: '920px', height: '592px', display: 'flex', flexDirection: 'column' }} >
          <Header />
          <div style={{ margin: '0px 96px', flexGrow: 1, display: 'flex', flexDirection: 'column' }} >
