...
function Header() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }} >
      <p style={{ margin: '0px 36px', fontSize: '24px' }} >
...
export function CreateNewDrawing(props: Props): React.ReactElement {
  ...
  return (
    <FloatingDrawingsContainer
      contained={
        <div style={{ margin: '0px 80px', width: '880px', height: '590px', display: 'flex', flexDirection: 'column' }} >
          <Header />
          <div style={{ margin: '0px 54px', flexGrow: 1, display: 'flex', flexDirection: 'column' }} >
