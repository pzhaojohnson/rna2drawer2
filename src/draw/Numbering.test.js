...
describe('Numbering class', () => {
  ...
  describe('_textPositioning static method', () => {
    it('in right quadrant', () => {
      ...
      let tp = Numbering._textPositioning(svg.line(1, 2, 3, 2));
      expect(
    ...
    it('in bottom quadrant', () => {
      let svg = createNodeSVG();
      let tp = Numbering._textPositioning(svg.line(-1, -4, -1, -3));
      expect(
    ...
    it('in left quadrant', () => {
      let svg = createNodeSVG();
      let tp = Numbering._textPositioning(svg.line(1, -1, -1, -1));
      expect(
    ...
    it('in top quadrant', () => {
      let svg = createNodeSVG();
      let tp = Numbering._textPositioning(svg.line(2, 5, 2, 3));
      expect(
  ...
  describe('mostRecentProps static method', () => {
    it('returns a new object', () => {
      let _mrps = Numbering._mostRecentProps;
      expect(_mrps).toBe(Numbering._mostRecentProps);
  ...
  describe('fromSavedState static method', () => {
    ...
    describe('invalid saved state', () => {
      ...
      it('constructor throws', () => {
        ...
        n._text.clear();
        n._text.tspan('9.9');
        expect(Numbering.fromSavedState(savableState, svg, 3, 5)).toBe(null);
      });
    });
    ...
    it('updates most recent properties', () => {
      ...
      let n3 = Numbering.fromSavedState(savableState1, svg, 1.4, 5.5);
      mrps = Numbering.mostRecentProps();
  ...
  describe('constructor', () => {
    ...
    it('validates text', () => {
      ...
      expect(() => { new Numbering(t, l, 3, 4) }).toThrow();
    });
  ...
  describe('_validateText method', () => {
    ...
    it('not a number', () => {
      ...
      let l = svg.line(1, 2, 3, 4);
      expect(() => { new Numbering(t, l, 2, 3) }).toThrow();
    });
    ...
    it('not an integer', () => {
      ...
      let l = svg.line(1, 2, 3, 4);
      expect(() => { new Numbering(t, l, 5, 6) }).toThrow();
    });
  });
  ...
  it('color getter and setter', () => {
    ...
    expect(Numbering.mostRecentProps().color).toBe('#132435');
  });
