...
it('one base hairpin', () => {
  ...
  checkCoords(
    ...
    [
      [11.444460181615778, 13.50187842406869],
    ],
  );
});
...
it('large base pair bond length', () => {
  ...
  checkCoords(
    baseCoordinatesHairpin(ur),
    [
      [10.681645314298521, -9.406469060840209],
      [5.619140260789209, -0.5494310073668203],
      [0.5182560115270007, 8.28555967588295],
      [-4.620911418311607, 17.098336685745835],
    ],
  );
});
...
it('large base pair bond length with one base hairpin', () => {
  ...
  checkCoords(
    baseCoordinatesHairpin(ur),
    [
      [2.2074641478043304, 3.3708306592473036],
    ],
  )
});
