...
it('one base hairpin', () => {
  ...
  checkCoords(
    ...
    [
      [11.762458177804735, 14.052667110173061],
    ],
  );
});
...
it('large base pair bond length', () => {
  ...
  checkCoords(
    baseCoordinatesHairpin(ur),
    [
      [11.235015029301167, -9.091764677173387],
      [6.171139402019207, -0.23232875467442682],
      [1.0688741885708168, 8.60505382870906],
      [-4.071684569872559, 17.420216724789725],
    ],
  );
});
...
it('large base pair bond length with one base hairpin', () => {
  ...
  checkCoords(
    baseCoordinatesHairpin(ur),
    [
      [2.758774104122949, 3.6891296109347422],
    ],
  );
});
