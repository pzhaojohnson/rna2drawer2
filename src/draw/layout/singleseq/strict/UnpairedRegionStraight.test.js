...
it("size of one - zero 3' stretches", () => {
  ...
  checkCoords(
    ...
    [
      [3.2026279441628827, -4.440892098500626e-16],
    ],
  );
});
...
it("size of four - zero 3' stretches", () => {
  ...
  checkCoords(
    baseCoordinatesStraight(ur, bps),
    [
      [3.178423233502272, 8.36121593216773],
      [1.8594744111674255, 8.36121593216773],
      [0.5405255888325788, 8.36121593216773],
      [-0.7784232335022678, 8.36121593216773],
    ],
  );
});
...
it("some negative 3' stretches that sum to more than the positive 3' stretches", () => {
  ...
  checkCoords(
    baseCoordinatesStraight(ur, bps),
    [
      [0.255536194934881, 18.071892593572226],
      [-0.3325288550172545, 17.26249049075713],
      [-14.910197090429131, -2.8019485110906963],
      [-15.498262140381266, -3.6113506139057936],
    ],
  );
});
...
it("all 3' stretches are negative", () => {
  ...
  checkCoords(
    baseCoordinatesStraight(ur, bps),
    [
      [-6.525160969158276, -8.02255815468372],
      [-5.320241263651219, -8.559022971068975],
      [-4.115321558144163, -9.09548778745423],
      [-2.910401852637106, -9.631952603839485],
    ],
  );
});
